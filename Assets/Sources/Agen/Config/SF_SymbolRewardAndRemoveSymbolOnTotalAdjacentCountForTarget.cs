...
{
    public sealed partial class SF_SymbolRewardAndRemoveSymbolOnTotalAdjacentCountForTarget : SymbolEffect
    {
        public SF_SymbolRewardAndRemoveSymbolOnTotalAdjacentCountForTarget(ByteBuf buf) : base(buf)
        {
        ...
        public static SF_SymbolRewardAndRemoveSymbolOnTotalAdjacentCountForTarget DeserializeSF_SymbolRewardAndRemoveSymbolOnTotalAdjacentCountForTarget(ByteBuf buf)
        {
            return new SF_SymbolRewardAndRemoveSymbolOnTotalAdjacentCountForTarget(buf);
        }
        ...
        public const int Id = -1548810382;
