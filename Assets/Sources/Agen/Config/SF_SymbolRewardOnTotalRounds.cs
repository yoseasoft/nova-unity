...
{
    public sealed partial class SF_SymbolRewardOnTotalRounds : SymbolEffect
    {
        public SF_SymbolRewardOnTotalRounds(ByteBuf buf) : base(buf)
        {
        ...
        public static SF_SymbolRewardOnTotalRounds DeserializeSF_SymbolRewardOnTotalRounds(ByteBuf buf)
        {
            return new SF_SymbolRewardOnTotalRounds(buf);
        }
        ...
        public const int Id = 1861566199;
