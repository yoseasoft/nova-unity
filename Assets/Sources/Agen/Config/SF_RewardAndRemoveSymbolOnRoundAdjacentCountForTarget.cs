...
{
    public sealed partial class SF_RewardAndRemoveSymbolOnRoundAdjacentCountForTarget : SymbolEffect
    {
        public SF_RewardAndRemoveSymbolOnRoundAdjacentCountForTarget(ByteBuf buf) : base(buf)
        {
        ...
        public static SF_RewardAndRemoveSymbolOnRoundAdjacentCountForTarget DeserializeSF_RewardAndRemoveSymbolOnRoundAdjacentCountForTarget(ByteBuf buf)
        {
            return new SF_RewardAndRemoveSymbolOnRoundAdjacentCountForTarget(buf);
        }
