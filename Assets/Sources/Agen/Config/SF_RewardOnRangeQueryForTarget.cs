...
{
    public sealed partial class SF_RewardOnRangeQueryForTarget : SymbolEffect
    {
        public SF_RewardOnRangeQueryForTarget(ByteBuf buf) : base(buf)
        {
        ...
        public static SF_RewardOnRangeQueryForTarget DeserializeSF_RewardOnRangeQueryForTarget(ByteBuf buf)
        {
            return new SF_RewardOnRangeQueryForTarget(buf);
        }
