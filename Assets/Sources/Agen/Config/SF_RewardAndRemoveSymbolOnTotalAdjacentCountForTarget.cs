...
{
    public sealed partial class SF_RewardAndRemoveSymbolOnTotalAdjacentCountForTarget : SymbolEffect
    {
        public SF_RewardAndRemoveSymbolOnTotalAdjacentCountForTarget(ByteBuf buf) : base(buf)
        {
        ...
        public static SF_RewardAndRemoveSymbolOnTotalAdjacentCountForTarget DeserializeSF_RewardAndRemoveSymbolOnTotalAdjacentCountForTarget(ByteBuf buf)
        {
            return new SF_RewardAndRemoveSymbolOnTotalAdjacentCountForTarget(buf);
        }
        ...
        public const int Id = -1499839302;
