...
{
    public sealed partial class IF_Used_RewardSymbol : ItemEffect
    {
        public IF_Used_RewardSymbol(ByteBuf buf) : base(buf)
        {
        ...
        public static IF_Used_RewardSymbol DeserializeIF_Used_RewardSymbol(ByteBuf buf)
        {
            return new IF_Used_RewardSymbol(buf);
        }
