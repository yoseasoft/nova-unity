...
namespace Game.Config
{
    ...
    {
        public MonsterConfig(ByteBuf buf)
        {
            id = buf.ReadInt();
            name = buf.ReadString();
            type = buf.ReadInt();
            ...
            deathExp = buf.ReadInt();

            PostInit();
        }

        public static MonsterConfig DeserializeMonsterConfig(ByteBuf buf)
        {
            return new MonsterConfig(buf);
        }
        ...
        /// 死亡产生经验值
        /// </summary>
        public readonly int deathExp;

        public const int Id = -55174244;
